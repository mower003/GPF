...
class EntityLineItemWidget():
    ...
    def __init__(self, parent_frame, viewcustomerframeclass, entity_id = -999, entity_name = None, st_number = None, st_name = None, city = None, state = None, zip = None, country = 'USA', is_active = None, * , entityObj = None):
